package net.mcreator.compartido;
...
@Mod("compartido")
public class CompartidoMod {
	public static final Logger LOGGER = LogManager.getLogger(CompartidoMod.class);
	public static final String MODID = "compartido";

	public CompartidoMod() {
